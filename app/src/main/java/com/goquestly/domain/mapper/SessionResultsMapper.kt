...
import com.goquestly.data.remote.dto.SessionResultsStatisticsDto
import com.goquestly.domain.model.ParticipantRanking
import com.goquestly.domain.model.SessionResults
import com.goquestly.domain.model.SessionResultsStatistics
...
fun SessionResultsStatisticsDto.toDomain(): SessionResultsStatistics {
    return SessionResultsStatistics(
